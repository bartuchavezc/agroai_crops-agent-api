...
def load_app_config() -> dict:
    ...
    unet_cfg["local_model_path"] = os.environ.get("UNET_LOCAL_MODEL_PATH", unet_cfg.get("local_model_path"))
    unet_cfg["device"] = os.environ.get("UNET_DEVICE", "cuda" if os.environ.get("USE_CUDA", "false").lower() == "true" else unet_cfg.get("device"))
